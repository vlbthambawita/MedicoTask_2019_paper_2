...
parser.add_argument("--data_root", 
                    default="/work/vajira/data/stacked_original_frames_18x256x256",
...
parser.add_argument("--ae_checkpoint", default="/work/vajira/mediaeval_2019_output/4200_0_mt_fold_1_stackedImages_18x256x256_AE_v2_Adam.py/checkpoints/4200_0_mt_fold_1_stackedImages_18x256x256_AE_v2_Adam.py_epoch:2725.pt", help="Pre-trained AE path")
...
class TubeEncoderDecoder(nn.Module):
    def __init__(self):
        ...
        self.decoder = nn.Sequential(
            ...
            nn.ConvTranspose2d(32, 16, 2, stride=2),
            nn.ReLU(),
            nn.ConvTranspose2d(16, 18, 2, stride=2 ),
            nn.ReLU())
